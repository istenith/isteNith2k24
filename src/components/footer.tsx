...
const Footer: React.FC = () => {
  return (
    ...
    <div className=" flex flex-col md:flex-row  lg:flex-row w-full justify-between mt-16 ">
    <div className=" flex lg:flex-row  mx-auto lg:ml-20 items-center">
    ...
    <div className=" flex lg:flex-row  mx-auto mt-7 pr-20 items-center ">
    ...
    <div className="lg:mr-20 flex lg:flex-row mt-7 mx-auto pr-7 items-center">
