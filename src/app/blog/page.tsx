    ...
    <div className="min-h-screen bg-custom-gray text-white">
      <div className="flex flex-row lg:flex-row">
        <div className="w-1/5 fixed lg:w-1/5 lg:mt-16 lg:ml-60 lg:fixed text-slate-200 flex flex-col lg:flex-col mt-24 ml-8 lg:justify-start bg-custom-gray lg:bg-transparent">
          ...
          <div className="from-neutral-400  text-6xl  lg:text-9xl font-sans -ml-4 mb-4">O</div>
          <div className="from-neutral-400  text-6xl lg:text-9xl font-sans -ml-4 mb-4">G</div>
          <div className="from-neutral-400   text-6xl lg:text-9xl font-sans -ml-4 mb-4">S</div>
        </div>
