    ...
    <>
      ...
      <div className="min-h-screen bg-[#171616] text-white">
        <div className="flex justify-center bg-white bg-opacity-90">
          <div className="text-black text-[40px] md:text-[75px] height-155 p-3 font-barlowb">
            EVENTS
          </div>
        </div>
        ...
        <div>
          <div className="mx-4 md:mx-8">
            <div className="text-2xl md:text-4xl md:mb-4 mb-2 my-8 md:my-12 font-barlowb">HULT PRIZE</div>
            <div className="flex flex-col md:flex-row">
              ...
              <div className="text mx-0 md:mx-8 text-white font-actor md:text-[26px] text-lg md:leading-8">
          ...
          <div className="boxset2 flex flex-col md:flex-row mx-4 md:mx-8">
            <Link href="/events/hult">
              <div className="flex bg-white w-full md:w-[38rem] h-[120px] mr-0 md:mr-8 text-black text-2xl items-center justify-center font-actor md:mt-0 mt-3 mb-4 md:mb-0">
                <div className="transition-transform duration-300 hover:-translate-y-1.5 cursor-pointer">
                  View Hult Prize&apos;s Gallery
                </div>
              </div>
            </Link>
            <div className="miniboxes flex gap-3 justify-center">
              <div className="transition-transform duration-300 hover:-translate-y-1.5 cursor-pointer w-[120px] h-[120px] bg-[#7D7B7B] items-center justify-center flex font-actor text-lg px-3">Even Semester</div>
              <div className="transition-transform duration-300 hover:-translate-y-1.5 cursor-pointer w-[120px] h-[120px] bg-[#7D7B7B] items-center justify-center flex font-actor text-lg px-3">Audi</div>
              <div className="transition-transform duration-300 hover:-translate-y-1.5 cursor-pointer w-[120px] h-[120px] bg-[#7D7B7B] items-center justify-center flex font-actor text-lg px-3">Last held in Jan 2023</div>
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="mx-4 md:mx-8">
            <div className="text-2xl md:text-4xl md:mb-4 mb-2 mt-7 md:mt-20 font-barlowb">PRODYOGIKI</div>
            <div className="flex flex-col md:flex-row">
              <div className="box min-w-full md:min-w-[38rem] mb-6 h-80 bg-white overflow-hidden">
                <Image
                  width={250}
          ...
          <div className="boxset2 flex flex-col md:flex-row mx-4 md:mx-8">
            <Link href="/events/prody">
              <div className="flex bg-white w-full md:w-[38rem] h-[120px] mr-0 md:mr-8 text-black text-2xl items-center justify-center font-actor md:mt-0 mt-3 mb-4 md:mb-0">
                <div className="transition-transform duration-300 hover:-translate-y-1.5 cursor-pointer">
                  View Prodyogiki&apos;s Gallery
                </div>
              </div>
            </Link>
            <div className="miniboxes flex gap-3 justify-center">
              <div className="transition-transform duration-300 hover:-translate-y-1.5 cursor-pointer w-[120px] h-[120px] bg-[#7D7B7B] items-center justify-center flex font-actor text-lg px-3">Even Semester</div>
              <div className="transition-transform duration-300 hover:-translate-y-1.5 cursor-pointer w-[120px] h-[120px] bg-[#7D7B7B] items-center justify-center flex font-actor text-lg px-3">Audi & Old LH</div>
              <div className="transition-transform duration-300 hover:-translate-y-1.5 cursor-pointer w-[120px] h-[120px] bg-[#7D7B7B] items-center justify-center flex font-actor text-lg px-3">Last held in April 2024</div>
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="mx-4 md:mx-8">
            <div className="text-2xl md:text-4xl md:mb-4 mb-2 mt-7 md:mt-20 font-barlowb">PAHAL</div>
            <div className="flex flex-col md:flex-row">
              <div className="box min-w-full md:min-w-[38rem] mb-6 h-80 bg-white overflow-hidden">
                <Image
                  width={250}
          ...
          <div className="boxset2 flex flex-col md:flex-row mx-4 md:mx-8">
            <Link href="/events/pahal">
              <div className="flex bg-white w-full md:w-[38rem] h-[120px] mr-0 md:mr-8 text-black text-2xl items-center justify-center font-actor md:mt-0 mt-3 mb-4 md:mb-0">
                <div className="transition-transform duration-300 hover:-translate-y-1.5 cursor-pointer">
                  View Pahal&apos;s Gallery
                </div>
              </div>
            </Link>
            <div className="miniboxes flex gap-3 justify-center">
              <div className="transition-transform duration-300 hover:-translate-y-1.5 cursor-pointer w-[120px] h-[120px] bg-[#7D7B7B] items-center justify-center flex font-actor text-lg px-3">Odd Semester</div>
              <div className="transition-transform duration-300 hover:-translate-y-1.5 cursor-pointer w-[120px] h-[120px] bg-[#7D7B7B] items-center justify-center flex font-actor text-lg px-3">Audi</div>
              <div className="transition-transform duration-300 hover:-translate-y-1.5 cursor-pointer w-[120px] h-[120px] bg-[#7D7B7B] items-center justify-center flex font-actor text-lg px-3">Last held in Aug 2023</div>
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="mx-4 md:mx-8">
            <div className="text-2xl md:text-4xl md:mb-4 mb-2 mt-7 md:mt-20 font-barlowb">PRARAMBH</div>
            <div className="flex flex-col md:flex-row">
              <div className="box min-w-full md:min-w-[38rem] mb-6 h-80 bg-white overflow-hidden">
                <Image
                  width={250}
          ...
          <div className="boxset2 flex flex-col md:flex-row mx-4 md:mx-8">
            <Link href="/events/prarambh">
              <div className="flex bg-white w-full md:w-[38rem] h-[120px] mr-0 md:mr-8 text-black text-2xl items-center justify-center font-actor md:mt-0 mt-3 mb-4 md:mb-0">
                <div className="transition-transform duration-300 hover:-translate-y-1.5 cursor-pointer">
                  View Prarambh&apos;s Gallery
                </div>
              </div>
            </Link>
            <div className="miniboxes flex gap-3 justify-center">
