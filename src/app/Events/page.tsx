  ...
  return (
    <div className="min-h-screen bg-[#1E1E1E] text-white">
      <div className="flex justify-center bg-white">
        <div className="text-black text-[60px] md:text-[120px] p-3 font-head">
          EVENTS
        </div>
      </div>
      ...
      <div>
        <div className="mx-4 md:mx-8">
          <div className="text-2xl md:text-4xl md:mb-4 mb-2 my-12 font-head ">HULT PRIZE</div>
          <div className="flex flex-col md:flex-row">
            <div className="box min-w-full md:min-w-[38rem] mb-6 h-80 bg-white"></div>
            <div className="text mx-0 md:mx-8 text-white font-desc text-lg md:text-xl">
      ...
      <div>
        <div className="mx-4 md:mx-8">
          <div className="text-2xl md:text-4xl md:mb-4 mb-2 mt-7 md:mt-20 font-head">PRODYOGIKI</div>
          <div className="flex flex-col md:flex-row">
            <div className="box min-w-full md:min-w-[38rem] mb-6 h-80 bg-white"></div>
            <div className="text mx-0 md:mx-8 text-white font-desc text-lg md:text-xl">
      ...
      <div>
        <div className="mx-4 md:mx-8">
          <div className="text-2xl md:text-4xl md:mb-4 mb-2 mt-7 md:mt-20 font-head">PAHAL</div>
          <div className="flex flex-col md:flex-row">
            <div className="box min-w-full md:min-w-[38rem] mb-6 h-80 bg-white"></div>
            <div className="text mx-0 md:mx-8 text-white font-desc text-lg md:text-xl">
      ...
      <div>
        <div className="mx-4 md:mx-8">
          <div className="text-2xl md:text-4xl md:mb-4 mb-2 mt-7 md:mt-20 font-head">PRARAMBH</div>
          <div className="flex flex-col md:flex-row">
            <div className="box min-w-full md:min-w-[38rem] mb-6 h-80 bg-white"></div>
            <div className="text mx-0 md:mx-8 text-white font-desc text-lg md:text-xl">
