...
description: "This article is a step by step detail of how one can write his/her own package manager in Julia..."
tags: ['julia', 'GPU' , "CUDA", "MabdleBrot"]
---
...
!cuda/9.0/Prod/local
!_installers/cuda-repo-ubuntu1604-9-0-local_9.0.176-1_amd64-deb
...
function mandelbrotplot()
  ...
  crmin = -2+.5+.3+.2
  crmax = 2.5-.5-.9-.4-.6-.3-.1-.1-.1-.1-.1-
  !.2-.01-.01-.01-.02-.01369-.0089-.00462952-.05
...
![mando](/assets/images/blogs_images/julia_on_gpu/mandlebrot.jpeg)

You can navigate/zoom into various parts of the set via `crmin`, `crmax`, `crmmin` values.

![mando](/assets/images/blogs_images/julia_on_gpu/mandopart.png)
