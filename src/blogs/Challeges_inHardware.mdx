...
description: More data has been created in the past two years than the entire history of the human race... 
tags: ['Hardware', 'IoT', 'AI','Embedded systems']
---


![hello](/assets/images/blogs_images/challlenges_in_hardware/cover.jpeg)
